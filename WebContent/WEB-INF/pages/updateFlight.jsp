...
<div class="card">
	<div class="card-body">
		...
		<form:form method = "POST" action="../updateFl" modelAttribute="flight">
			<input type="hidden" name="id" value="${flight.id}">
			
			<div class="form-group">
				<form:label path="depCity">Departure city</form:label>
				<form:select path="depCity" class="form-control" disabled="true">
			...
			<div class="form-group">
				...
				<form:select path="arrCity" class="form-control" disabled="true">
					<form:option value="0" label="Select" />
					<form:option value="Phoenix" label="Phoenix" />
					<form:option value="Atlanta" label="Atlanta" />
					<form:option value="San Francisco" label="San Francisco" />
			...
			<div class="form-group">
				...
				<form:select path="plane" class="form-control" disabled="true">
